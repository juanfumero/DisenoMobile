var App = function(){ //se crea una clase
// se declaran con "var" para que solo seana accedidas desde dentro de la funcion
var inicio = '#inicio';
...
$(document).on('pagebeforeshow', function() {
	...
	$('#presupuestos').load('componentes/presupuesto.html', function(){
		$('.navegacion').load('componentes/menu.html',function(){
			$('[data-type="search"]').attr('placeholder', "filtrar elementos");
			$('[data-role="page"]').trigger('create');
		});
	});*/
});